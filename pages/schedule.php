...
function getPastelColorClass($color) {
    switch ($color) {
        case 'blue': return 'bg-[var(--color-pastel-blue)] border-blue-200 text-blue-800';
        case 'green': return 'bg-[var(--color-pastel-green)] border-green-200 text-green-800';
        case 'purple': return 'bg-[var(--color-pastel-purple)] border-purple-200 text-purple-800';
        case 'orange': return 'bg-[var(--color-pastel-orange)] border-orange-200 text-orange-800';
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button onclick="window.print()" class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition shadow-sm">
