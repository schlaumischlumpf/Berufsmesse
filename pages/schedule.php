        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex gap-2">
                    <a href="?page=print-view" target="_blank" class="bg-gradient-to-r from-emerald-500 to-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-emerald-600 hover:to-green-700 transition shadow-sm inline-flex items-center gap-2">
                        <i class="fas fa-file-pdf"></i> PDF Ansicht
                    </a>
                    <button onclick="window.print()" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-200 transition shadow-sm inline-flex items-center gap-2">
